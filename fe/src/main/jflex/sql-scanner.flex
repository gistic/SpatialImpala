...
%{
  ...
  static {
    ...
    keywordMap.put("overlaps", new Integer(SqlParserSymbols.KW_OVERLAPS));    
    ...
    keywordMap.put("polygon", new Integer(SqlParserSymbols.KW_POLYGON));    
    ...
    keywordMap.put("rectangle", new Integer(SqlParserSymbols.KW_RECTANGLE));    
