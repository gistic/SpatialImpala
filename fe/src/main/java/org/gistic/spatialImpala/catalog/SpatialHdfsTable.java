...
public class SpatialHdfsTable extends HdfsTable {
  ...
  public SpatialHdfsTable(TableId id, org.apache.hadoop.hive.metastore.api.Table msTbl,
  ...
  public static boolean isSpatial(org.apache.hadoop.hive.metastore.api.Table msTbl) {
    return msTbl != null && msTbl.getParameters() != null
        && msTbl.getParameters().get(GlobalIndex.GLOBAL_INDEX_TABLE_PARAM) != null;
  }
}
