  ...
  if (is_collection_field) {
    ...
    switch (slot_desc->type().type) {
      ...
      case TYPE_DECIMAL:
        ...
        break;
      case TYPE_RECTANGLE:
        reader = new ScalarColumnReader<Rectangle, true>(this, node, slot_desc);
        break;
      case TYPE_POINT:
        reader = new ScalarColumnReader<Point, true>(this, node, slot_desc);
        break;
      case TYPE_LINE:
        reader = new ScalarColumnReader<Line, true>(this, node, slot_desc);
        break;
      default:
